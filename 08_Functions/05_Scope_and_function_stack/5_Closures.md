...
1. Why is this useful for a Backend Dev?
...
1. The "Backpack" Analogy
   Imagine a function is a hiker. - Lexical Scope is the map the hiker was born with. - The Closure is the backpack. - When the function (the hiker)
...
1. Closures in Node.js (Real World)
